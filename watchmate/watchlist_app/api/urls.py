...
from watchlist_app.api.views import ReviewList, ReviewDetail, StreamPlatformAV, StreamPlatformDetailAV, StreamPlatformVS, WatchListAV, WatchDetailAV, ReviewCreate
